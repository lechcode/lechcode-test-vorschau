...
**Gesamtampel: 🟡 GELB** · 0 rot / 11 gelb / 5 grün · 13.07.2026 11:21 · Dauer 69 s · lc-qa.py
...
- **Playwright-Lauf**: page.goto: net::ERR_CONNECTION_TIMED_OUT at http://localhost:62807/datenschutz.html
Call log:
  - navigating to "http://localhost:62807/datenschutz.html", waiti
- **Playwright**: 
